...
-- Ejemplo: actualizar email del cliente con id_cliente = 3
UPDATE Clientes SET email_cliente = 'nuevo.email@ejemplo.com' WHERE id_cliente = 3;

-- 9. Elimina un cliente por su ID.
-- Ejemplo: eliminar cliente con id_cliente = 5
...
SELECT COUNT(*) AS prendas_mayores_50 FROM Prendas WHERE precio > 50;
...
-- Ejemplo para cliente con id_cliente = 1
...
-- Ejemplo: cambia talla prenda id 4 a 'L'
UPDATE Prendas SET talla = 'L' WHERE id_prenda = 4;
...
-- Ejemplo eliminar empleado con id_empleado = 3
...
('Zara Sol', 'Calle Sol, 1', 'Madrid', 'España'),
('Zara Retiro', 'Avenida Retiro, 45', 'Madrid', 'España');
